...
from fusion.imagedet.src.datasets.base import BaseDataset
from fusion.imagedet.src.utils.boxes import generate_anchors
...
class KITTI(BaseDataset):
    ...
    def get_sample_ids(self):
        ...
        sample_ids_path = os.path.join(self.data_dir, 'ImageSets', sample_set_name)
