...
from fusion.imagedet.src.utils.image import whiten, drift, flip, resize, crop_or_pad
from fusion.imagedet.src.utils.boxes import compute_deltas, visualize_boxes
...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def preprocess(self, image, image_meta, boxes=None,cfg=None):
