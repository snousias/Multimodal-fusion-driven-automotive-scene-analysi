...
class Config(object):
    def __init__(self):
        ...
        self.parser.add_argument('--seed', type=int, default=42,
                                 help='random seed')
        self.parser.add_argument('--cfg_file', type=str, default='',
                            help='specify the config for demo')
        self.parser.add_argument('--data_path', type=str,
                            default='',
                            help='specify the point cloud data file or directory')
        self.parser.add_argument('--ckpt', type=str, default='pointrcnn_7870.pth', help='specify the pretrained model')
        self.parser.add_argument('--ext', type=str, default='.bin',
