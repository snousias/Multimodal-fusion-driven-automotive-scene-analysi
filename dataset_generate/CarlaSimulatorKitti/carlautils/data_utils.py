        ...
        for act in actors:
            ...
            if kitti_datapoint is not None:
                if "vehicle" in act.type_id:
                    kitti_datapoint.type = "Car"
                if "walker.pedestrian" in act.type_id:
                    kitti_datapoint.type = "Pedestrian"
                if "vehicle.carlamotors." in act.type_id:
                    kitti_datapoint.type = "Truck"
                if "vehicle.vespa" in act.type_id:
                    kitti_datapoint.type = "Cyclist"
                if "harley" in act.type_id:
                    kitti_datapoint.type = "Cyclist"
